...

{
  ...
  if($deadline < $today)
  {
    echo "<script>alert('unable to register.. please check the deadline');document.location='sportsday.php'</script>";
  }
  else
  {
    header("location:regsports.php");
  }
}
else
{
  echo "<script>alert('unable to register.. dates have not been published');document.location='sportsday.php'</script>";
}
}
$sql = "SELECT itemname FROM eventlist  WHERE eventday='sd'";
$all_categories = mysqli_query($conn,$sql);
$numevent=mysqli_num_rows($all_categories );
  ...
  <section id="header">
    <div class="header container">
      <div class="nav-bar">
        <div class="brand">
          <a href="#hero">
            <h1><span></span><span>sports day</span></h1>
          </a>
        </div>
        <div class="nav-list">
          <div class="hamburger">
          ...
          <ul>
            ...
            <li><a href="index.php" data-after="Contact">logout</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <!-- End Hero Section  -->
   ...
   <section id="about">
    <div class="about container">
      <div class="col-left">
        <div class="about-img">
          <img src="images/sportsposter.jpg" alt="img">
        </div>
      </div>
      <div class="col-right">
        <h1 class="section-title">About <span>sports day</span></h1>
        <h2>sports day</h2>
        <h2>Event Date :<?php echo $date?>;</h2>
         <h2>Registration open till :<?php echo $deadline?>;</h2>
           
        <p>Sports Day is a day of honoring and awarding the talented students who are participating in sports inside the campus. Intramural tournaments helps to reduce stress, enhance the leadership quality and a good way to meet new people and make new friends for the students. For that, our department conducts house wise Intramural Tournaments in four disciplines for both Men and Women separately.</p>
  ...
  <section id="services">
    <div class="services container">
      <div class="service-top">
        ...
        <p>Sports day is composed of various extra curricular events in which every students can actively participate and showcase their talents</p>
      </div>
      ...
      <div class="service-item">
        ...
        <?php
            $sql1 = "SELECT * FROM eventlist WHERE eventday='sd'";
