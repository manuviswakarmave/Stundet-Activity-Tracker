...
if(isset($_POST['submit']))
{
    ...
    $sql = "SELECT * FROM regarts WHERE userid='$userid'";
    $result=mysqli_query($conn,$sql);
    ...
    {
        $sql= "UPDATE regarts SET $e ='no' WHERE userid='$userid'";
        $result=mysqli_query($conn,$sql);
    }
endwhile;
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title> JHALAK Registration Form </title>--->
